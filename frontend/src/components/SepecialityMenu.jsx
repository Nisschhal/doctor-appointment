      ...
      <div className="flex sm:justify-center gap-4 pt-5 w-full">
        {specialityData.map((item, index) => (
          <Link
            ...
            className="flex flex-col items-center text-xs cursor-pointer  shrink-0 hover:translate-y-[-10px] transition-all duration-300"
...
export default SepecialityMenu
